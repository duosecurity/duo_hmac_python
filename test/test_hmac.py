...
class TestHmac(unittest.TestCase):
  ...
  def assert_components(self, method, params, headers, expected_uri, expected_body, expected_headers):
    actual_uri, actual_body, actual_headers = self.hmac.get_authentication_components(method, API_PATH, params, headers)
  ...
  def test_get_no_params_no_headers(self):
    ...
    self.assert_components(HTTP_GET, None, None, expected_uri, expected_body, expected_headers)
  ...
  def test_post_no_params_no_headers(self):
    ...
    self.assert_components(HTTP_POST, None, None, expected_uri, expected_body, expected_headers)
  ...
  def test_get_one_param_no_headers(self):
    ...
    in_params = {'foo': 'bar'}
    self.assert_components(HTTP_GET, in_params, None, expected_uri, expected_body, expected_headers)
  ...
  def test_post_one_param_no_headers(self):
    ...
    in_params = {'foo': 'bar'}
    self.assert_components(HTTP_POST, in_params, None, expected_uri, expected_body, expected_headers)
  ...
  def test_get_multi_param_multi_headers(self):
    ...
    self.assert_components(HTTP_GET, in_params, in_headers, expected_uri, expected_body, expected_headers)
  ...
  def test_post_multi_params_multi_headers(self):
    ...
    self.assert_components(HTTP_POST, in_params, in_headers, expected_uri, expected_body, expected_headers)
